...
/////////////////////////////////////////////
// BUTTONS
const int N_BUTTONS = 6 + 5; //*  total numbers of buttons. Number of buttons in the Arduino + number of buttons on multiplexer 1 + number of buttons on multiplexer 2...
